...
def verficar_fermat_refactorizado(a, b, c, n):
    if n>2:
        if math.pow(a, n) + math.pow(b, n) ==math.pow(c, n):
            print("¡Fermat se equivoco!")
        else:
            print("No, esa combinacion no funciona")
...
if __name__ == "__main__":
    ...
    verficar_fermat_refactorizado(3, 4, 5, 4)
    print("Distancia calculada:", calcular_distancia(0, 0, 3, 4))
    print("Distancia calculada (refactorizado):", calcular_distancia_refactorizado(0, 0, 3, 4))
    print("Distancia calculada (refactorizado v2):", calcular_distancia_refactorizado_v2(0, 0, 3, 4))
    print("Respuesta bot:", obtener_saludo_agente())
    print("Respuesta bot (refactorizado):", obtener_saludo_agente_refactorizado())
